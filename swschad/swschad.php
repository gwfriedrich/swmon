...
//			html += "<option SELECTED>???</option>";
	...
	function loadData() {
		...
		var bounds = new google.maps.LatLngBounds();
			...
			var url = "./swschad/scripte/phpsqlajax_genxml.php?vondatum=" + vondatum + "&bg=" + bg + "&sys=" + sys;
			downloadUrl(url, function(doc) {
			var xml = xmlParse(doc);
    ...
    function saveData() {
      ...
      var url = "./swschad/scripte/phpsqlinfo_addrow_neu.php?bg=" + bg + "&sys=" + sys + "&anzahl=" + anzahl + "&address=" + address + "&ort=" + ort + "&datum=" + datum + "&uhrzeit=" + uhrzeit + "&type=" + type + "&kz=" + kz + "&mitglied=" + usr + "&text1=" + text1 + "&lat=" + latlng.lat() + "&lng=" + latlng.lng();
    ...
    function editData(id) {
      ...
      var url = "./swschad/scripte/php_edit_point_neu.php?bg=" + bg + "&sys=" + sys + "&anzahl=" + anzahl + "&address=" + address + "&ort=" + ort + "&datum=" + datum + "&uhrzeit=" + uhrzeit + "&type=" + type + "&kz=" + kz + "&mitglied=" + usr + "&text1=" + text1 + "&lat=" + latlng_marker.lat() + "&lng=" + latlng_marker.lng() + "&id=" + id;
      downloadUrl(url, function(data, responseCode) {
        if (responseCode == 200 && data.length <= 1) {
          infoWindow.close();
		  loadData ();
        ...
        <td style="color: #4444ff; vertical-align: top"> 
			...
			<div style="float:right; margin-top:3px">
				...
				<form action="get" method="post" onsubmit="loadData(); return false" style="clear:both">
					<p style="margin:0">
					<input id="vondatum" size="8" type="date" value="" />
					</p>
				</form>
			</div>
