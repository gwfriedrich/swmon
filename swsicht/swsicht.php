...
//	var sys = 'rdbms.strato.de';
    ...
    var customIcons = {
      ...
      Frischl: {
        icon: "./images/googlemaps/frischl.png"},
      Ueberl: {
        icon: "./images/googlemaps/ueberl.png"},
      klRotte: {
	...
	function createMarker(point,point_id,datum,anzahl,kz,type,html) {
		...
		side_bar_html += '<tr> <td  width="50" align="center" > '+ anzahl +' </td> <td> <a href="javascript:myclick(' + (gmarkers.length-1) + ') " > '+ datum +' </td> <td width="60" align="center" > '+ kz +' </td> </tr>';
	}
...
//				address_html += "<option SELECTED>???</option>";
				...
				address_html += "<option value='Frischl'>Frischl</option>";
...
//			html += "<option SELECTED>???</option>";
			...
			html += "<option value='Frischl'>Frischl</option>";
...
//					html += "<table><tr><td>Foto: <input type='button' class='edit_button' value='" + fname + "' onclick='window.open('./displayf.php?tname="+ tname + ".JPG', 'Display', 'width=500,height=375,resizable=yes') </td></tr></table>";
				...
				var html_edit = "<div id='infofenster'><table>";
					...
					html_edit += "<tr><td>Typ:</td> <td><select id='type'>";
						...
						html_edit += "<option value='Frischl'>Frischl</option>";
	...
	function deletePoint(id) {
		var url = "./swsicht/scripte/php_delete_point.php?point_id=" + id + "&bg=" + bg + "&sys=" + sys;
		downloadUrl(url, function(data, responseCode) {
			if (responseCode == 200 && data.length <= 1) {
			  infoWindow.close();
			  loadData ();
...
<table border="0" width="800" style="margin-left:auto; margin-right:auto; margin-top:3px;">
    <tr style="font-size:12px">
		...
		<td align="center" valign="middle"><img class='xyz' src="./images/googlemaps/frischl.png" alt="Frischl" />Frischl</td>
        ...
        <td style="color: #4444ff; vertical-align: top"> 
			...
			<div id="side_bar_titel">
				<table border="0">
						...
						<td width="90" align="left" >Datum</td>
						<td width="60" align="left" >Rotte</td>
				</table>
			</div> 
			<div id="side_bar"></div> 
        </td> 
