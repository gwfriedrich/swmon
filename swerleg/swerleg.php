...
//			html += "<option SELECTED>???</option>";
	...
	function loadData() {
		...
		var bounds = new google.maps.LatLngBounds();
			...
			var url = "./swerleg/scripte/phpsqlajax_genxml.php?vondatum=" + vondatum + "&bg=" + bg + "&sys=" + sys;
			downloadUrl(url, function(doc) {
			var xml = xmlParse(doc);
    ...
    function saveData() {
      ...
      var url = "./swerleg/scripte/phpsqlinfo_addrow_neu.php?bg=" + bg + "&sys=" + sys + "&anzahl=" + anzahl + "&address=" + address + "&ort=" + ort + "&datum=" + datum + "&uhrzeit=" + uhrzeit + "&type=" + type + "&kz=" + kz + "&mitglied=" + usr + "&text1=" + text1 + "&lat=" + latlng.lat() + "&lng=" + latlng.lng();
    ...
    function editData(id) {
      ...
      var url = "./swerleg/scripte/php_edit_point_neu.php?bg=" + bg + "&sys=" + sys + "&anzahl=" + anzahl + "&address=" + address + "&ort=" + ort + "&datum=" + datum + "&uhrzeit=" + uhrzeit + "&type=" + type + "&kz=" + kz + "&mitglied=" + usr + "&text1=" + text1 + "&lat=" + latlng_marker.lat() + "&lng=" + latlng_marker.lng() + "&id=" + id;
      downloadUrl(url, function(data, responseCode) {
        if (responseCode == 200 && data.length <= 1) {
          infoWindow.close();
		  loadData ();
